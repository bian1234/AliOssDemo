...
//
//    // 上传文件
//    private String localFilePath = "E:\\test\\8月.xlsx";
//    // Endpoint以北京为例，其它Region请按实际情况填写。
//    private String endpoint = "http://oss-cn-beijing.aliyuncs.com";
//    // 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维，
//    // 请登录 https://ram.console.aliyun.com 创建RAM账号。
//    private String accessKeyId  ="LTAI8wWiL59xBmmb";
//    private String accessKeySecret = "I5dZEhyCNUnTKFLoRQihINUqoVB14X";
//    // 这是你创建的存储桶的名称
//    private String bucketName = "<yourBucketName>";
//    // 文件名称
//    private String objectName = "<8月是个好日子>";
//    /**
//     * 表单上传
//     * @throws Exception
//     */
...
//        FormUploadDemo formUploadDemo = new FormUploadDemo();
//        formUploadDemo.PostObject();
//    }
//}
